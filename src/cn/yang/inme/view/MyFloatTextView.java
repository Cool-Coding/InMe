...
public class MyFloatTextView extends TextView {
    ...
    private WindowManager.LayoutParams wmParams = ((Inme) getContext().getApplicationContext()).getMywmParams();

    public MyFloatTextView(Context context) {
        super(context);
